...
return [
    ...
    'phone_invalid' => 'رقم الهاتف غير صحيح (يجب أن يبدأ بـ 0 أو +)',
    'phone_exists' => 'رقم الهاتف هذا مسجل مسبقاً',
    ...
    'too_far_from_branch' => 'عفواً، أنت بعيد جداً عن موقع الفرع لتسجيل الحضور',
    'already_checked_in_today' => 'لقد قمت بتسجيل الحضور بالفعل لهذا اليوم في هذا الفرع',
    'check_in_successful' => 'تم تسجيل الحضور بنجاح، عمل ممتع!',
    'no_active_check_in_found' => 'عفواً، لم يتم العثور على تسجيل حضور نشط لليوم لتسجيل الانصراف',
    'check_out_successful' => 'تم تسجيل الانصراف بنجاح، يومك سعيد!',
    'branch_id_required' => 'يجب اختيار الفرع أولاً لتسجيل الحضور',
    'branch_not_found' => 'الفرع المختار غير موجود في النظام',
    'phone_required' => 'رقم الهاتف مطلوب لإتمام الحجز',
    'phone_string' => 'رقم الهاتف يجب أن يكون نصاً صالحاً',
    'phone_max' => 'رقم الهاتف لا يجب أن يتجاوز 20 حرفاً',
    'phone_regex' => 'رقم الهاتف المدخل غير صالح (يرجى إدخاله بصيغة صحيحة تبدأ بـ 0 أو +)',
];
